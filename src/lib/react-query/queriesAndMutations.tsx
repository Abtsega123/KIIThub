...
import { QUERY_KEYS } from './queryKeys';
  ...
  export const useCreatePost = () => {
    ...
    return useMutation({
      mutationFn: (post: INewPost) => createPost(post), // Assuming createPost is defined elsewhere
      onSuccess: () => {
...
export const useSavePost = () => {
  ...
  export const useGetPosts = () => {
    return useInfiniteQuery({
      ...
      queryFn: ({ pageParam = 0 }) => getInfinitePosts({ pageParam }), // Adjust the default value as needed
